...
public static class TenantErrors
{
    ...
    public static readonly Error SubdomainAlreadyExists =
        Error.Conflict("Tenant.SubdomainExists", "Ce sous-domaine est deja utilise.");

    public static readonly Error TenantNotActive =
        Error.Forbidden("Tenant.NotActive", "Ce tenant est suspendu ou annule.");

    public static readonly Error TenantNotResolved =
        Error.Unauthorized("Tenant.NotResolved", "Impossible de determiner le tenant.");
}
