...
/// <summary>
/// Entité principale du module Tenants.
/// Représente un client/organisation dans le système SaaS.
///
/// Pattern : Rich Domain Model + Factory Method
/// </summary>
public sealed class Tenant : BaseEntity
{
    ...
    public void Upgrade(TenantPlan newPlan)
    {
        Plan = newPlan;
        SetUpdatedAt();
    }
